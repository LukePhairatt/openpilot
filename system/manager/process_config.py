...
def driverview(started: bool, params: Params, CP: car.CarParams) -> bool:
  return True ##started or params.get_bool("IsDriverViewEnabled")
...
procs = [
  ...
  NativeProcess("modeld", "selfdrive/modeld", ["./modeld.py"], always_run),   
  ...
  PythonProcess("calibrationd", "selfdrive.locationd.calibrationd", always_run),
